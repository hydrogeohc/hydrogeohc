...
- **Cloud & Tools:** Azure (CosmosDB, AI Foundry), AWS (S3/Lambda, Batch, Sagemaker, CDK), Google Cloud Platform (BigQuery, Anthos, Cloud Run, VertexAI), Git/GitHub, Huggingface, Apache Spark
