...
- **AI/ML & Data Science:** Large Language Models (Gemini, GPT, Claude), Regression and Classification Models, Anomaly Detection, Time Series Analysis, NLP, Computer Vision
- **Cloud & Tools:** Azure (CosmosDB, AI Foundry, Fabric, Github Copilot), AWS (S3/Lambda, Batch, Sagemaker, CDK, Bedrock), Google Cloud Platform (BigQuery, Anthos, Cloud Run, VertexAI), Git/GitHub, Huggingface, Apache Spark
